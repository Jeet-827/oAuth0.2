  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-5 bg-gradient-to-br from-white to-blue-50">
      <div className="w-full max-w-[440px] bg-white border border-slate-200 rounded-3xl p-10 shadow-[0_10px_40px_-10px_rgba(37,99,235,0.1),0_20px_25px_-5px_rgba(0,0,0,0.04)] animate-in fade-in slide-in-from-bottom-5 duration-700 ease-out">
        <h1 className="text-3xl font-extrabold text-slate-900 text-center mb-2 tracking-tight">Welcome back</h1>
        <p className="text-slate-500 text-center mb-8 text-[0.95rem]">Please enter your details to sign in</p>

        <button type="button" className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-slate-200 rounded-xl text-slate-600 font-semibold transition-all hover:bg-slate-50 hover:border-slate-300 hover:shadow-sm active:translate-y-[1px] mb-6" onClick={handleGoogleLogin}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between mb-6 text-sm">
            ...
            <a href="#" className="text-blue-600 font-bold hover:text-blue-700 hover:underline transition-colors">Forgot password?</a>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-500">
          ...
          <Link to="/signup" className="text-blue-600 font-bold hover:text-blue-700 hover:underline transition-colors">Create account</Link>
        </div>
      </div>
    </div>
  );
